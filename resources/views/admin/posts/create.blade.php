...
@section('content')
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            {!! Form::open(array('action' => 'Admin\PostsController@store')) !!}
            {{-- Title form input --}}
            ...
            <div class="row">
                <div class="form-group col-sm-3">
                    ...
                    {!! Form::select('categories', $categories, [], ['multiple', 'class' => 'form-control', 'name' =>
                    'categories[]']) !!}
                ...
                <div class="form-group col-sm-3">
                    ...
                    {!! Form::select('tags', $tags, [], ['multiple', 'class' => 'form-control', 'name' =>
                    'tags[]']) !!}
                    @if ($errors->has('tags'))
                        <div class="text-danger">
                            {{ $errors->first('tags') }}
